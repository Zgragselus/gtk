                                        ...
                                        gint        *ret_format)
{
  ...
  gdk_property_get (requestor,
                    gdk_atom_intern_static_string ("REQUESTED_TARGET"),
                    GDK_NONE,
                    0,
                    G_MAXULONG,
                    FALSE,
  ...
  if (target == gdk_atom_intern_static_string ("TARGETS"))
    {
      ...
      gdk_property_change (requestor,
                           gdk_atom_intern_static_string ("POSSIBLE_TARGETS"),
      ...
      event->selection.property = gdk_atom_intern_static_string ("POSSIBLE_TARGETS");
      ...
      if (best_i >= 0)
        {
          ...
          event->selection.selection = selection;
          event->selection.target = target;
          event->selection.property = gdk_atom_intern_static_string ("REQUESTED_TARGET");
          event->selection.time = time;
          event->selection.requestor = g_object_ref (requestor);
